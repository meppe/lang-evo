#!/bin/bash
docker rm ros-lang-evo-kinetic_agent_$1
xhost +local:`docker inspect --format='{{ .Config.Hostname }}' ros-lang-evo-kinetic_agent_$1` 
nvidia-docker run \
--rm \
-it \
...
--name ros-lang-evo-kinetic_agent$1 \
